...
>(({ className, children, ...props }, ref) => {
  const Component = DialogPrimitive.Trigger as any
  return (
    <Component
      ref={ref}
      className={className}
...
const DialogClose = React.forwardRef<
  ...
  any
>(({ className, children, ...props }, ref) => {
  const Component = DialogPrimitive.Close as any
  return (
    <Component
      ref={ref}
      className={className}
...
>(({ className, ...props }, ref) => {
  const Component = DialogPrimitive.Overlay as any
  return (
    <Component
      ref={ref}
      className={cn(
...
>(({ className, children, ...props }, ref) => {
  const Component = DialogPrimitive.Content as any
  return (
    <DialogPortal>
      <DialogOverlay />
      <Component
...
>(({ className, ...props }, ref) => {
  const Component = DialogPrimitive.Title as any
  return (
    <Component
      ref={ref}
      className={cn(
...
>(({ className, ...props }, ref) => {
  const Component = DialogPrimitive.Description as any
  return (
    <Component
      ref={ref}
